...
Major change made to the UI.  Removed the Treeview for signal display and began using a DataGridView.  Hopefully, this will allow for multiselect in the near future and also provide a way to group signals according to their underlying type and proportionally to their range.
